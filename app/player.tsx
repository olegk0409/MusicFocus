...
import { Sound, soundsList } from "@/src/utills/data";
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.contentContainer}>
        ...
        >
          {soundsList.filter(item => (category ? (item.category === category) : true) && item.name.toLowerCase().includes(query)).map((sound, index) => (
            <SoundItem 
...
export default withScreenLayout(PlayerScreen)
